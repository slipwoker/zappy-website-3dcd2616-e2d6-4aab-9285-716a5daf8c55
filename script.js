    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פרויקט לירוי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3dcd2616-e2d6-4aab-9285-716a5daf8c55',
                    name: data.name || '',
                    email: data.email || '',
